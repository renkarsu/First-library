...
* なんでコンストラクタ内のCalculateAreaなどの関数はTriangle::を付けるのか? <br>
A. そのコンストラクタに使われている関数はどこから来た関数か分かるようにするため.<br>
他のメンバ関数についてないのは定義してるからで,当然つかない.<br>
sqrtも使われるときはbrahman::にしてる.<br>
なぜこれを書いたかと言うと眠い時に"コンストラクタ内でTriangle::が何故あるの？"<br>
となったため.<br>
